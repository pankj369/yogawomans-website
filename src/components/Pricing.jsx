...
const plans = [
  {
    ...
    features: [
      ...
      "Beginner's yoga guide PDF",
    ],
    missing: ["Live Q&A sessions", "1-on-1 consultations", "Retreats access"],
  ...
  },
  {
    ...
    yearlyPrice: 1999,
    color: "#E8651A",
    tagline: "Most popular — complete wellness",
    features: [
    ...
    missing: ["1-on-1 consultations", "Retreats access"],
  ...
  },
  {
    ...
    yearlyPrice: 3999,
    color: "#5B6ABF",
    tagline: "Full transformation experience",
    features: [
      "Everything in Wellness",
      "2 × 1-on-1 sessions/month",
